		...
		<div class="row">
			<nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
				<ul class="nav nav-pills flex-column">
					<li class="nav-item">
						<a style="background-color: #D1B1D1!important;" class="nav-link active" href="#">Inicio <i class="material-icons">home</i></a>
					</li>
					<li class="nav-item">
			...
			<main class="col-sm-9 ml-sm-auto col-md-10 pt-3" role="main">
				<h1 class="titt">Inicio <div id="resp"></div></h1> 

				<?php include('tickets/abrir_nota.php');?>
			</main>
		</div>
	</div>
...
<script type="text/javascript" src="tickets/main.js"></script>
<script type="text/javascript">
function loadXMLDoc()
{

  //Scan
   //var str = document.getElementById("producto_buscar").value;
 
var xmlhttp;

var n=document.getElementById('producto_buscar').value;
...
xmlhttp.open("POST","productos/lista_venta.php",true);
